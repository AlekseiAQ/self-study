...
EXAMPLES = (
    ...
    [
        ...
        (([0, 1, 2, 8, 13, 17, 19, 32], 3), False),
        (([0, 1, 2, 8, 13, 17, 19, 32], 8), True),
        (([], 13), False),
        (([1], 15), False),
        (([15], 15), True),
        (([1, 2], 15), False),
        (([1, 15], 1), True),
        (([1, 15], 15), True),
        (([0, 1, 2, 8, 13, 17, 19, 32], 0), True),
        (([0, 1, 2, 8, 13, 17, 19, 32], 32), True),
        (([0, 1, 2, 8, 13, 17, 19, 32, 42], 0), True),
        (([0, 1, 2, 8, 13, 17, 19, 32, 42], 42), True),
        (([0, 1, 2, 8, 13, 17, 19, 19, 32], 19), True),
        (([0, 1, 2, 8, 13, 17, 19, 19, 32], 13), True),
